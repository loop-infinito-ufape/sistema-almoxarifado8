...
<form action="{{route('servidor.criar')}}" method="POST">
@csrf
...
<!-- div com label + input area formam um grup form -->
    ...
    <div class="form-group ">
        <div>
            ...
            <input id="sala_id" type="text" class="form-control @error('sala_id') is-invalid @enderror" name="sala_id" value="{{ old('sala_id') }}" autocomplete="sala_id" autofocus>
